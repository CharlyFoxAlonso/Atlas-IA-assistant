...
Módulo de auto-conocimiento de Atlas v3.4.
...
def generar_reporte_completo(incluir_codigo=True, max_lineas_codigo=50):
    ...
    # ========================================
    lineas.append("=" * 70)
    lineas.append("  ATLAS v3.4 - INFORME TÉCNICO DE AUTO-CONOCIMIENTO")
    lineas.append("=" * 70)
    ...
    lineas.append("=" * 70)
    lineas.append("")
    lineas.append("  Este informe fue generado automáticamente por Atlas v3.4.")
